...
<body>
    ...
    <section id="header">
        <a href="#"><img src="UrbanFashionImg/logo1.png" class="logo" alt="fashionista_logo"></a>
         <div>
            <ul id="navbar">
                <li><a class="active" href="Fashionistaafterlogin.php">Home</a></li>
         ...
         <div id="mobile">
            <a href="mycart.php"><i class="fas fa-shopping-bag"></i></a>
    ...
    <section id="product1" class="section-p2">
        ...
        <div class="pro-container">
            <div class="pro">
                ...
                <a href="shop.php"><i class="fas fa-shopping-cart cart"></i></a>
            </div>
    ...
    <section id="banner1" class="section-m1">
        ...
        <a href="ngo.php"><button class="normal">Explore More</button></a>
    </section>
