...
<body>
    ...
    <section id="contact-details" class="section-p1a">
        <div class="details">
        ...
        <div class="map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.4755497649894!2d73.02088931437629!3d19.042818057964325!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c3db5e2c85cd%3A0xef26c52d7d73816e!2sSIES%20Graduate%20School%20of%20Technology!5e0!3m2!1sen!2sin!4v1666876398971!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </section>

    <section id="form-details">
        <form action="contactconnectdb.php" method="POST">
            <span>LEAVE A MESSAGE</span>
            <h2>We love to hear from you</h2>
            <input type="text" placeholder="Your Name" name="name" required>
            <input type="text" placeholder="E-mail" name="email" required>
            <input type="text" placeholder="Subject" name="subject" required>
            <input type="text" name="message" id="inputmssge" required placeholder="Your Message">
        ...
        <div class="people">
            <div>
                <img src="UrbanFashionImg/people/1.png" alt="">
                <p><span>Chirag Gupta</span> Web Developer <br> Phone: +000 123 000 77 88<br>Email: chiragg9221@gmail.com </p>

            </div>

            <div>
                <img src="UrbanFashionImg/people/2.png" alt="">
                <p><span>Sneha Baital</span> Web Developer <br> Phone: +000 123 000 77 88<br>Email: baitalsneha@gmail.com </p>

            </div>

            <div>
                <img src="UrbanFashionImg/people/3.png" alt="">
                <p><span>Saloni Kharat</span> Web Developer <br> Phone: +000 123 000 77 88<br>Email: salonikharat1234@gmail.com </p>
            </div>

            <div>
                <img src="UrbanFashionImg/people/4.png" alt="">
                <p><span>Tarun Iyer</span> Web Developer <br> Phone: +000 123 000 77 88<br>Email: taruniyer09@gmail.com </p>
            </div>
        </div>
    </section>
