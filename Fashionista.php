...
<body>
    <section id="header">
        <a href="#"><img src="UrbanFashionImg/logo1.png" class="logo" alt="fashionista_logo"></a>
         <div>
            <ul id="navbar">
                <li><a class="active" href="Fashionista.php">Home</a></li>
         ...
         <div id="mobile">
            <a href="#" onclick="Login()"><i class="fas fa-shopping-bag"></i></a>
    ...
    <section id="hero">
        ...
        <a href="shopbeforelogin.php"><button>SHOP NOW</button></a>

    </section>
   
    <section id="feature" class="section-p1">
        <div class="fe-box">
            <img src="UrbanFashionImg/features/f1.png" alt="">
            <h6>Free shipping</h6>
        </div>
        <div class="fe-box">
            <img src="UrbanFashionImg/features/f2.png" alt="">
            <h6>Online Order</h6>
        </div>
        <div class="fe-box">
            <img src="UrbanFashionImg/features/f3.png" alt="">
            <h6>Save Money</h6>
        </div>
        <div class="fe-box">
            <img src="UrbanFashionImg/features/f4.png" alt="">
            <h6>Promotions</h6>
        </div>
        <div class="fe-box">
            <img src="UrbanFashionImg/features/f5.png" alt="">
            <h6>Happy Sell</h6>
        </div>
        <div class="fe-box">
            <img src="UrbanFashionImg/features/f6.png" alt="">
            <h6>F24/7 Support</h6>
        </div>
    </section>
        ...
        <div class="pro-container">
            <div class="pro">
                ...
                <div class="des">
                    <!-- <span>adidas</span> -->
                    <br>
                    <h5>Puma Astronaut T-Shirts</h5>
                    <h4>₹600</h4>
                </div>
                <a href="shopbeforelogin.php"><i class="fas fa-shopping-cart cart"></i></a>
            </div>
            ...
            <div class="pro">
                ...
                <div class="des">
                    <!-- <span>adidas</span> -->
                    <br>
                    <h5>Gucci Half-Sleeves Shirts</h5>
    ...
    <section id="banner" class="section-m1">
        ...
        <h2>Up to <span>70% Off</span> -All Styles of clothes</h2>
        <a href="shopbeforelogin.php"><button class="normal">Explore More</button></a>
    </section>
    ...
    <section id="banner1" class="section-m1">
        <h4><span>Planting Trees </span>Were Never So Easy!</h4>
        <p>Now, plant trees from the comfort of your home by just buying clothes with a few easy steps!</p>
        <a href="ngobeforelogin.php"><button class="normal">Explore More</button></a>
    </section>
        ...
        <section id="banner3">
            ...
            <div class="banner-box banner-box2">
                <h2>TROUSER COLLECTION</h2>
                <h3>Trendy Trousers</h3>
            </div>
