...
<body>
        ...
        <a href="#"><img src="UrbanFashionImg/logo1.png" class="logo" alt="fashionista_logo"></a>
         <div>
            <ul id="navbar">
                ...
                <li><a class="active" href="aboutbeforelogin.php">About</a></li>
    ...
    <section id="page-header" class="about-header">
        <h2>#KnowUs</h2>
        <p>Get to know about your very own Fashionista</p> 
    </section>

    <section id="about-head" class="section-p1">
        <img src="UrbanFashionImg/about/a6.jpg" alt="">
        <div>
            <h2>Who We Are?</h2>
            <p>Fashionista is a shop which sells items of ready-made clothing.
                A small shop which sells expensive or designer clothing may be called a boutique. 
                A shop that sells clothes for a narrowly-restricted market such as school uniforms or 
                outdoor sports may be called an outfitter. <br><br>This is a website where you can not only find your 
                fashion but also lead to a social cause. Get a chance to contribute for saving the environment. Planting Trees Were 
                Never So Easy! Now, plant trees from the comfort of your home by just buying clothes with a few easy steps!</p>
            
            <abbr title="">Shop more than ₹ 2000 and get a chance to save the environment! </abbr>

            <br><br>

            <marquee bgcolor="#ccc" loop="-1" scrollamount="5" width="100%">Tie up with Vasant Vihar Anand Vihar Foundation.</marquee>
        </div>
    </section>
