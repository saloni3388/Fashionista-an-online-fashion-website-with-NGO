...
<body>
        ...
        <a href="#"><img src="UrbanFashionImg/logo1.png" class="logo" alt="fashionista_logo"></a>
         <div>
            <ul id="navbar">
                ...
                <li><a class="active" href="ngobeforelogin.php">NGO</a></li>
    ...
    <section id="page-header" class="ngo-header">
        <h2>#Make a Contribution</h2>
        <p>Shop more than ₹ 2000 and get a chance to save the environment! 
        <br><br>Tie up with <span>Vasant Vihar Anand Vihar Foundation.</span></p>
    </section>

    <section class="container">
        <h2 class="head">Planting Trees Were Never So Easy!</h2>
        <p class="para">Now, plant trees from the comfort of your home by just buying clothes with a few easy steps!</p>
        <div class="row">
         <div class="col-lg-12">
            <div class="featuredPropBox">
             <ul>
                <li> <a href="#">
                  <div class="fplogo"><h2>Step 01</h2></div>
                  <div class="fptext">
                   <p>Shop for more than <br>₹ 2000 and get a chance to save the environment</p>
                 </div>
                  </a> </li>
                <li> <a href="#">
                  <div class="fplogo"><h2>Step 02</h2></div>
                  <div class="fptext">
                   <p>Proceed to payment and get directed to our NGO page</p>
                 </div>
                  </a> </li>
                <li> <a href="#">
                  <div class="fplogo"><h2>Step 03</h2></div>
                  <div class="fptext">
                   <p>Choose a sapling you wish to plant</p>
                 </div>
                  </a> </li>  
                  <li> <a href="#">
                    <div class="fplogo"><h2>Step 04</h2></div>
                    <div class="fptext">
    ...
    <section id="product2" class="section-p2">
        <h2 class="ngohead">Choose a Sapling</h2>
        <p>New collection with Modern Designs</p>
        <div class="pro-container1">
            <div class="pro1">
                <img src="UrbanFashionImg/r10.jpg" alt="">
                <div class="des1">
                    <h5>Banyan Plant</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            </div>

            <div class="pro1">
                <img src="UrbanFashionImg/r12.jpg" alt="">
                <div class="des1">
                    <h5>Neem Plant</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r18.jpg" alt="">
                <div class="des1">
                    <h5>Mango Plant</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r16.jpg" alt="">
                <div class="des1">
                    <h5>Tulsi Plant</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r14.jpg" alt="">
                <div class="des1">
                    <h5>Indian Almond</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r15.webp" alt="">
                <div class="des1">
                    <h5>Jamun Tree</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r2.webp" alt="">
                <div class="des1">
                    <h5>Pink Rose</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r3.webp" alt="">
                <div class="des1">
                    <h5>Red Rose</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="http://cdn.shopify.com/s/files/1/0047/9730/0847/collections/nurserylive-vinca-plants-category-image.jpg?v=1621058865" alt="">
                <div class="des1">
                    <h5>Periwinkle</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r4.jpg" alt="">
                <div class="des1">
                    <h5>Hibiscus</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r5.jpg" alt="">
                <div class="des1">
                    <h5>Red Daisy</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r6.webp" alt="">
                <div class="des1">
                    <h5>Iris</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r7.jpg" alt="">
                <div class="des1">
                    <h5>Jasmine</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="http://cdn.shopify.com/s/files/1/0047/9730/0847/collections/nurserylive-lily-plants-category-image.jpg?v=1619691382" alt="">
                <div class="des1">
                    <h5>Lily</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
            ...
            <div class="pro1">
                <img src="UrbanFashionImg/r9.jpg" alt="">
                <div class="des1">
                    <h5>Lavender</h5>
                    <button type="submit" onclick="Login()" name="Add_To_Ngo" class="btn">Choose</button>
                </div>
    ...
    <section id="contact-details" class="section-p1a" style="margin-bottom: 70px;">
        <div class="details">
        ...
        <div class="map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3767.936070773192!2d73.19584990000001!3d19.1979944!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be793705b120cab%3A0x5f0a3833d7e59a97!2sVasant%20Vihar%20Rd%2C%20Shiv%20Shakti%20Nagar%2C%20Ambernath%2C%20Maharashtra%20421501!5e0!3m2!1sen!2sin!4v1667033366182!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </section>
    ...
    <!-- <script>
        function Choose(){
            alert("Thank You for your Contribution!! Your sapling will get planted.");
        } -->
    <script>
        function Login(){
            alert("Login to Explore shop")
        }
    </script>
